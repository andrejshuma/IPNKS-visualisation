...
const Sidebar = () => {
    ...
    const {selectedNode, selectedNodeDetails, setSearchedMentor, activeNodeFilter} =
        useGlobalContext();
                                ...
                                <div className="dropdown-list">
                                    {selectedNodeDetails.mentorCollaborations.length > 0 ? (
                                        ...
                                        <p className="no-data">
                                            ...
                                            {activeNodeFilter.min != null && activeNodeFilter.max != null && (
                                                <> со колаборации во рангот
                                                    од {activeNodeFilter.min} до {activeNodeFilter.max}</>
                                            )}
                                            {activeNodeFilter.min != null && activeNodeFilter.max == null && (
                                                <> со колаборации во рангот од {activeNodeFilter.min} до ∞</>
                                            )}
                                            {activeNodeFilter.min == null && activeNodeFilter.max != null && (
                                                <> со колаборации во рангот од 0 до {activeNodeFilter.max}</>
                                            )}
                                        </p>
